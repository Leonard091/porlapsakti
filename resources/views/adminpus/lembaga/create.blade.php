                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('lembaga.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_perpus" class="form-control" value="{{ old('nama_perpustakaan') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_kab_kota" id="kabupaten_kota" class="form-select" required>
                                ...
                                @foreach ($kabupatenKotas as $kabupatenKota)
                                    <option value="{{ $kabupatenKota->id }}">{{ $kabupatenKota->nama_kab_kota }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                if (provinsiId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#kabupaten_kota').append('<option value="" disabled selected>Pilih Kabupaten/Kota</option>');
                ...
                if (kecamatanId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#kelurahan_desa').append('<option value="" disabled selected>Pilih Kelurahan/Desa</option>');
                            $.each(data, function(key, value) {
